...
class InviteCodeWindow(BaseWindow):
    # Сигналы для перехода
    switchToLogin = pyqtSignal()

    # Характеристики окна
    widowTitle: str = 'Система складского учета - Пригласительный код'
    ...
    def init_ui(self):
        ...
        self.cardLayout.addWidget(self.inviteCode, alignment=Qt.AlignmentFlag.AlignHCenter)
